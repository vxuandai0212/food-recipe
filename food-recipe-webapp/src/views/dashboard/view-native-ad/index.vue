...
import TableComp from '@/views/dashboard/view-native-ad/components/table.vue'
import PaginationComp from '@/views/dashboard/view-native-ad/components/pagination.vue'
...
export default class List extends Vue {
  get title() { return 'Lượt xem Native Ad' }
