...
import TableComp from '@/views/ingredient/detail/warning/components/table.vue'
import FormDialog from '@/views/ingredient/detail/warning/components/form-dialog.vue'
import DeleteDialog from '@/views/ingredient/detail/warning/components/delete-dialog.vue'
...
export default class List extends Vue {
  ...
  get emptyTableMessage() { return 'Không có chú ý nào' }
  ...
  async getAllItem() {
    ...
    await this.$store.commit('ingredientInfo/SET_LIST_QUERY_TYPES', [
      INGREDIENT_INFO_TYPE.WARNING_OVERUSE, INGREDIENT_INFO_TYPE.WARNING_CONSUMER, INGREDIENT_INFO_TYPE.WARNING_COMBINE
    ])
