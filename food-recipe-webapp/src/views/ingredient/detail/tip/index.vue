...
import TableComp from '@/views/ingredient/detail/tip/components/table.vue'
import FormDialog from '@/views/ingredient/detail/tip/components/form-dialog.vue'
import DeleteDialog from '@/views/ingredient/detail/tip/components/delete-dialog.vue'
...
export default class List extends Vue {
  ...
  get emptyTableMessage() { return 'Không có mẹo nào' }
  ...
  async getAllItem() {
    ...
    await this.$store.commit('ingredientInfo/SET_LIST_QUERY_TYPES', [
      INGREDIENT_INFO_TYPE.TIP_SELECT, INGREDIENT_INFO_TYPE.TIP_PREPROCESS, INGREDIENT_INFO_TYPE.TIP_PRESERVE
    ])
